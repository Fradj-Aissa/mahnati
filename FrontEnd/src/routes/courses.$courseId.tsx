        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-6 space-y-3">
              ...
              {lessons.length === 0 && (
                <p className="py-8 text-center text-muted-foreground">هذه الدورة عبارة عن حقيبة تعليمية متكاملة بملف شامل يضم كل المحاور والدروس التي تحتاجها. يمكنك تحميل الملف مباشرة بالضغط على "تحميل الملف" في الأسفل، مع إمكانية الدراسة بمرونة في أي وقت يناسبك. كما يمكنك وضع علامة "اكتملت الدورة" عند الانتهاء منها، ليتم توجيهك إلى المرحلة القادمة من التكوين.</p>
              )}
